  ...
  },
  {
    ...
    children: [
      ...
      // },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/system/course.vue"
          ),
      },
      {
        path: "/system-teacher",
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/system/teacher.vue"
          ),
      },
      {
        path: "/system-student",
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/system/student.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/system/tmessage.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/system/smessage.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/system/management.vue"
          ),
      },
      {
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/pages/reset-pwd.vue"
          ),
      },
      {
        path: "/system-journal",
        ...
        component: () =>
          import(
            /* webpackChunkName: "system-notice" */ "../views/system/journal.vue"
          ),
      },
      // {
